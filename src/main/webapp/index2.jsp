...
<body>
								...
								<tr onmouseover="this.style.backgroundColor='#FFFFCC'"
									...
									<td class="mainPageUl"><a
										...
										title="${news.caption}" target="blank">
											<div style="width:260px;heigth:36px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">
												${requestScope.newsCaptionsList[newsTypeStatus.index].get(status.index)}
											</div>
									</a></td>
									<td align="right" width="130" style="font-size:13px;"><myTag:LocalDateTimeTag
	...
	<iframe style="margin-left:38%;" frameborder="no" border="0" marginwidth="0" marginheight="0" width=330 height=110 src="//music.163.com/outchain/player?type=0&id=2335377860&auto=0&height=90"></iframe>
</body>
