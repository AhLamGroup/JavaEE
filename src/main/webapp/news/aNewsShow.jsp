...
<link href="/news/css/buttons.css" rel="stylesheet" type="text/css">
...
<body>
	<div class="center" style="width:800px;margin-top:30px;">
		<table width="800" border="0">
			<tbody>
				<tr>
					<td class="newsCaption">${requestScope.news.caption}
					<c:if
							test="${sessionScope.user.type=='manager' && requestScope.news.check==0 }">
							<br>
							<a href="/news/servlet/NewsServlet?type1=passCheck&newsId=${news.newsId}" style="height:30px;font-size:80%;line-height:30px;"><input type="button" value="待审核"></a>
						</c:if>
					</td>
				<tr>
